...
public class TC_OFOS_007 extends Base_Test{
	@Test
	public void CripsyChickenOrderingFood() throws IOException, InterruptedException {
		...
		e.getCrispyChickenStripsAddToCart().click();
		...
		Thread.sleep(1000);
		alert.accept();
		Assert.assertEquals(title1,driver.getTitle(),"The oders is not present in the cart");	
		}
