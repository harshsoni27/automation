...
public class TC_OFOS_012 extends Base_Test{
	@Test
	public void BuffaloWingsOrderingFood() throws IOException, InterruptedException {
		...
		h.getBuffaloWingsAddToCart().click();
