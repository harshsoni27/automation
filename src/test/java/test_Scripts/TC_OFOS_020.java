...
public class TC_OFOS_020 extends Base_Test{
	 @Test
		public void CashOnDeliveryOption() throws InterruptedException, IOException {
			...
			ToscanaRestaurantPage p = new ToscanaRestaurantPage(driver);
			p.getTacoBellAddToCart().click();
			p.getCheckButton().click();
