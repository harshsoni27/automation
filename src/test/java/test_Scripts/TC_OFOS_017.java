...
public class TC_OFOS_017 extends Base_Test{
	@Test
	public void PrawnCrackersOrderingFood() throws InterruptedException, IOException {
		...
		n.getPrawnCrackersAddToCart().click();
