...
public class TC_OFOS_008 extends Base_Test{
	@Test
	public void LemonGrilledChickenOrderingFood() throws InterruptedException, IOException {
		...
		e.getLemonGrilledchickenAddToCart().click();
		e.getLemonGrilledchickenAddToCart().click();
